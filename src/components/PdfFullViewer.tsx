    ...
    <div className="w-full flex gap-4">
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center justify-between mb-2">
          <p className="text-sm text-neutral-600 dark:text-neutral-400">{pages.length} página(s) · elige una página con las miniaturas y coloca tu firma</p>
                  ...
                  >
                    <div className="relative group">
                      ...
                      <div className="absolute -top-8 left-0 flex gap-1 opacity-0 group-hover:opacity-100 transition">
                        <button onClick={onSignCopy} className="w-6 h-6 rounded-md bg-neutral-200 dark:bg-neutral-800 border border-neutral-300 dark:border-white/20 text-[11px] text-neutral-900 dark:text-white hover:bg-neutral-300 dark:hover:bg-neutral-700" title="Copiar firma"><CopySimple size={11} weight="bold" /></button>
