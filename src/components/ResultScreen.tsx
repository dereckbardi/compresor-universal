...
const ACTION_TEXT: Record<string, { msg: string; btn: string }> = {
  ...
  "png-pdf": { msg: "Tus imágenes se han convertido a PDF", btn: "Descargar PDF" },
  "webp-pdf": { msg: "Tus imágenes se han convertido a PDF", btn: "Descargar PDF" },
  "tiff-pdf": { msg: "Tus imágenes se han convertido a PDF", btn: "Descargar PDF" },
