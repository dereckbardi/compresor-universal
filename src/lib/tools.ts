...
export const TOOLS: Tool[] = [
  ...
  { id: "add-pages", name: "Agregar páginas", desc: "Inserta otro PDF en una posición específica del documento.", icon: "FilePlus", category: "ordenar", available: false },
  { id: "remove-blank", name: "Eliminar páginas en blanco", desc: "Detecta y elimina las páginas vacías de tu PDF automáticamente.", icon: "MagicWand", category: "ordenar", available: false },
  ...
  { id: "flatten", name: "Aplanar PDF", desc: "Elimina capas y transparencias para dejar el PDF listo para imprenta.", icon: "Stack", category: "optimizar", available: false },
  ...
  { id: "pdf-markdown", name: "PDF a Markdown", desc: "Convierte tu PDF a Markdown editable para notas y documentación.", icon: "MarkdownLogo", category: "desde-pdf", available: false },
  { id: "compare", name: "Comparar PDF", desc: "Detecta las diferencias entre dos archivos PDF.", icon: "GitDiff", category: "desde-pdf", available: false },
  ...
  { id: "view-meta", name: "Ver metadatos", desc: "Consulta el título, autor y fecha de tu PDF.", icon: "FileMagnifyingGlass", category: "editar", available: false },
  { id: "annotate", name: "Anotar PDF", desc: "Subraya, dibuja y añade texto sobre tu PDF.", icon: "Highlighter", category: "editar", available: false },
