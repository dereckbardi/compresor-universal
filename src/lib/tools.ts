...
export const TOOLS: Tool[] = [
  // IMÁGENES
  { id: "image", name: "Comprimir imágenes", desc: "Reduce el peso de tus fotos JPG, PNG, WebP y GIF sin perder calidad, ideal para compartirlas más rápido.", icon: "🖼️", category: "imagenes", available: true, popular: true, tagline: "La forma más rápida de aligerar tus fotos" },
  // ORDENAR
  { id: "merge", name: "Unir PDF", desc: "Combina varios PDF en un solo archivo, en el orden que quieras.", icon: "🧩", category: "ordenar", available: true, popular: true, tagline: "Junta varios PDF en uno solo en segundos" },
  ...
  // OPTIMIZAR
  { id: "pdf", name: "Comprimir PDF", desc: "Reduce el peso de tu PDF para que pese menos y sea más fácil de compartir, sin perder calidad.", icon: "🗜️", category: "optimizar", available: true, popular: true, tagline: "Envía tus PDF por correo o WhatsApp sin líos" },
  ...
  { id: "word-pdf", name: "WORD a PDF", desc: "Convierte documentos de Word en PDF manteniendo el formato original.", icon: "W", category: "a-pdf", available: true, popular: true, tagline: "Tu documento de Word, listo para enviar como PDF" },
  ...
  { id: "pdf-word", name: "PDF a WORD", desc: "Convierte tu PDF en un documento de Word editable.", icon: "W", category: "desde-pdf", available: true, popular: true, tagline: "Edita ese PDF como si fuera un Word normal" },
